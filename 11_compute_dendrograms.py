...
min_members  = 1
directories  = glob.glob("/mnt/data01/antonio/Dropbox/BSL/CRSMEX/Dendrograms/2020MAR27/sequence_xc9500_coh9500/sequence_*/")
...
for dir in directories:
	...
	if N >= min_members:
		...
		plt.text(0.65,0.85,r'$\Delta\sigma=\,$' + str(int(np.round(ds_lim/1e6))) + r'$\,MPa$',fontsize=16, transform=ax.transAxes)
		plt.text(0, 1.025*r_max,r'$r_{max}=$' + str(int(np.round(r_max))) + r'$\,m$',fontsize=18)
